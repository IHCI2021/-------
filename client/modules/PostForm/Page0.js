           ...
           <Form autoComplete="on">
            <Form.Item
              ...
              (<AutoComplete 
                ...
                >
                  <Input.TextArea maxLength="50" type="string" allowclear="true"/>
                </AutoComplete>)       
              ...
              >
                  {getFieldDecorator('item_code',{ 
                    ...
                    rules:[
                      {required:true,
                      message:'请输入事项代码，必填'},
                      { pattern:new RegExp('^[A-Z0-9]{31}$'),
                      message:'31个字符,只能输入数字或大写字母',
                      }
                    ]
                  })
              ...
              >
                ...
                (<AutoComplete 
                  ...
                  //onSelect={(value)=>{console.log(value)}}
                  >
                    <Input.TextArea maxLength="150" type="string" allowclear="true"autosize={{ minRows: 2, maxRows: 4 }}/>
                  </AutoComplete>)
                  }
                  </Form.Item>
                  ...
                  >
                    ...
                    (<AutoComplete 
                      ...
                      //onSelect={(value)=>{console.log(value)}}
                      >
                        <Input.TextArea maxLength="100" type="string" allowclear="true"autosize={{ minRows: 2, maxRows: 4 }}/>
                      </AutoComplete>)
