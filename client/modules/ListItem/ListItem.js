...
toindex(){
  ...
  logout(){
    ...
    getItems(value){
      ...
      let that = this;
      axios.get('http://10.147.15.189:8000/api/material/getList', {
        headers: {
    ...
    delSelectedItems(){
        ...
        for(let i=0; i<this.state.selectedRowKeys.length; i++){
          ...
          axios({
            method:"post",
            url:"http://10.147.15.189:8000/api/material/removeMany",
    ...
    searchItem(itemName){
      ...
      let that = this;
      axios.get('http://10.147.15.189:8000/api/material/findItem', {
        headers: {
          'Authorization': that.state.token,
        },
        params: {
    ...
    // getItem = async() => {
    //   let data;
    //   await axios.get('http://10.147.15.189:8000/api/material/getItemByCode', {
    //       headers: {
    //         'Authorization': that.state.token
    //                 },
    //       params: {
          ...
          render: (text, record)=>(
            ...
            <Button type="danger" style={{marginLeft: 8}} onClick={()=>{
              ...
              let that = this;
                axios({
                method:"post",
                url:"http://10.147.15.189:8000/api/material/removeOne",
